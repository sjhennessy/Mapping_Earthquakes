...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  // 3. Use d3.json to make a call to get our Tectonic Plate geoJSON data.(NEED THEN FUNCTION????, see line 170)
// Perform a GET request to the Github URL for tectonic plate data
...
d3.json(queryUrl).then(function(data) {
 ...
 // Finally add tectonic plates to the map.
